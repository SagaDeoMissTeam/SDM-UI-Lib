package net.sixik.sdmuilib.client.screen.examples;

import net.minecraft.client.gui.GuiGraphics;
import net.minecraft.network.chat.Component;
import net.sixik.sdmuilib.client.screen.BaseScreen;
...
import net.sixik.sdmuilib.client.widgets.buttons.SimpleButtonWidget;
