...
//import net.sixik.v2.widgetsFake.RGBFakeWidget;
...
//    }
    ...
    public static void renderObjectWithRotation(GuiGraphics graphics, Vector2 pos, Vector2 size, Object object, RGB rgb) {
        ...
        GLRenderHelper.pushTransform(graphics, pos, size, 1, source.nextFloat() * 360f);
        rO(graphics,pos, size, object, rgb);
...
//    }
     ...
     * It then applies a random rotation between 0 and 360 degrees to the object using {@link GLRenderHelper#pushTransform(GuiGraphics, Vector2, Vector2, float, float)}.
     * The object is rendered using the provided {@link GuiGraphics}, position, size, type, and color.
     * Finally, the transformation is popped from the graphics context using {@link GLRenderHelper#popTransform(GuiGraphics)}.
     */
...
//    }
     ...
     * A random rotation between 0 and 360 degrees is applied to the object using {@link GLRenderHelper#pushTransform(GuiGraphics, Vector2, Vector2, float, float)}.
     * The object is rendered using the provided {@link GuiGraphics}, position, size, type, and color.
     * Finally, the transformation is popped from the graphics context using {@link GLRenderHelper#popTransform(GuiGraphics)}.
     */
...
//            @Override
//            public void draw(GuiGraphics graphics) {
//                GLRenderHelper.pushTransform(graphics, pos, sizeD, 1, source.nextFloat() * 360f);
...
//    }
    ...
    private static void rO(GuiGraphics graphics, Vector2 pos, Vector2 size,Object object, RGB rgb){
        switch (object) {
            case CUBE -> rgb.draw(graphics, pos.x, pos.y, size.x, size.y);
